...
console.log(`6. Release =`, os.release()); // OS Releas Version
...
console.log(`1. CPU =`, os.cpus()); // Total CPU Core
...
//console.log(`1. Error =`, os.constants()); // Uncaught TypeError TypeError: os.constants is not a function